...
class TSIDWrapper:
    ...
    def set_RF_pos_ref(self, pos, vel=None, acc=None):
        X = self.rf_ref.value(); X[:3] = pos
        V = self.rf_ref.derivative(); V[:3] = vel
        A = self.rf_ref.second_derivative(); A[:3] = acc
    ...
    def set_RH_pos_ref(self, pos, vel, acc):
        X = self.rh_ref.value(); X[:3] = pos
        V = self.rh_ref.derivative(); V[:3] = vel
        A = self.rh_ref.second_derivative(); A[:3] = acc
    ...
    def set_LH_pos_ref(self, pos, vel, acc):
        X = self.lh_ref.value(); X[:3] = pos
        V = self.lh_ref.derivative(); V[:3] = vel
        A = self.lh_ref.second_derivative(); A[:3] = acc
