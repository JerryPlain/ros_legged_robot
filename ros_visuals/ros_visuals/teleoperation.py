...
class InteractiveMarkerNode(Node):
    def __init__(self):
        ...
        # TODO create a tf listener (Search base_link -> arm_right_7_link)
        ...
        self.pose_pub = self.create_publisher(PoseStamped, 'right_hand_goal', 10)
        
    def setup_marker(self):
    
        # TODO Use the tf listner to retrive the 'arm_right_7_link' wrt 'base_link' transformation
        trans = self.tf_buffer.lookup_transform('base_link', 'arm_right_7_link', rclpy.time.Time()) # TODO get the transformation 
